...
export default class SnapShot extends Component {
    ...
    setData = ()=>{
        ...
        if(user.event == "none"){
            ...
            let c = <Image style={s.img1} source={this.state.car} resizeMode="contain"/>
            ...
            let c = <View style={s.sec1}>

                    <View style={s.sec2}>
                        <View style={{backgroundColor:Consts.colors.c2, borderRadius:10, height:"100%", width:`${this.state.progress}%`}}/>
                        <Image style={s.img2} source={this.state.car} resizeMode="contain"/>
                    </View>
